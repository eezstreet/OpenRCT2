...
const rct_string_id PeepThoughts[] = {
    ...
    STR_PEEP_THOUGHT_TYPE_FREEZING,
    STR_PEEP_THOUGHT_TYPE_COLD,
    STR_PEEP_THOUGHT_TYPE_HOT,
    STR_PEEP_THOUGHT_TYPE_TOO_COLD,
    STR_PEEP_THOUGHT_TYPE_ICE_CREAM_TOO_COLD,
    STR_PEEP_THOUGHT_TYPE_COFFEE_TOO_HOT,
    STR_PEEP_THOUGHT_TYPE_HOT_CHOCOLATE_TOO_HOT,
};
