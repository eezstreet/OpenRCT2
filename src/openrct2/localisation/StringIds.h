...
enum
{
    ...
    // new climates
    STR_CLIMATE_ARID_WARM = 6329,
    STR_CLIMATE_ARID_COLD = 6330,
    STR_CLIMATE_SEMI_ARID = 6331,
    STR_CLIMATE_MEDITERRANEAN = 6332,
    STR_CLIMATE_TEMPERATE = 6333,
    STR_CLIMATE_TROPICAL = 6334,
    STR_CLIMATE_TROPICAL_SAVANNAH = 6335,
    STR_CLIMATE_ISLAND = 6336,
    STR_CLIMATE_TAIGA = 6337,
    STR_CLIMATE_TUNDRA = 6338,
    STR_CLIMATE_ARID_COLD_S = 6339,
    STR_CLIMATE_MEDITERRANEAN_S = 6340,
    STR_CLIMATE_TEMPERATE_S = 6341,
    STR_CLIMATE_TROPICAL_SAVANNAH_S = 6342,
    STR_CLIMATE_TAIGA_S = 6343,
    STR_CLIMATE_HELL = 6344,
    STR_CLIMATE_MARS = 6345,

    // new scenario options
    STR_STARTING_MONTH = 6346,
    STR_STARTING_MONTH_TIP = 6347,
    STR_ENDING_MONTH = 6348,
    STR_ENDING_MONTH_TIP = 6349,
    STR_GUEST_GENERATION_ALGORITHM = 6350,
    STR_GUEST_GENERATION_ALGORITHM_TIP = 6351,
    STR_ADVERTISEMENT_GENERATION_ALGORITHM = 6352,
    STR_ADVERTISEMENT_GENERATION_ALGORITHM_TIP = 6353,
